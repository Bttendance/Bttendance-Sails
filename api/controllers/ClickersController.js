	...
	click: function(req, res) {
		...
		.exec(function callback(err, user) { 
		  ...
		  .exec(function callback(err, clicker) {
			  ...
			  if (choice_number == 1)
			    return res.send(500, Error.toast(req, "Clicker Click Error", "You've chosen A as a choice."));
			  else if (choice_number == 2)
			    return res.send(500, Error.toast(req, "Clicker Click Error", "You've chosen B as a choice."));
			  else if (choice_number == 3)
			    return res.send(500, Error.toast(req, "Clicker Click Error", "You've chosen C as a choice."));
			  else if (choice_number == 4)
			    return res.send(500, Error.toast(req, "Clicker Click Error", "You've chosen D as a choice."));
			  else
			    return res.send(500, Error.toast(req, "Clicker Click Error", "You've chosen E as a choice."));
		  });
		});
	}
