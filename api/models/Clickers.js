...
module.exports = {
  ...
  afterCreate: function(values, next) {
    ...
    console.log('afterCreate : Clicker');

    for (var i =  1; i <= Math.round(values.progress_time / 2.5); i++) {
      setTimeout(function() { 
        ...
        .exec(function callback(err, clicker) {
          ...
          console.log('Clicker Socket Boradcast : ' + clicker.a_students + ' : ' + clicker.b_students + ' : ' + clicker.c_students + ' : ' + clicker.d_students + ' : ' + clicker.e_students);
